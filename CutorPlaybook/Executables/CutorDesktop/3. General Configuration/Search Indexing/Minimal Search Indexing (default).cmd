...
:: Add only the Start Menu and CutorDesktop paths by default
:: The Cutor folder is so that if the user searches for a Cutor-modified feature, a script shows up in search
